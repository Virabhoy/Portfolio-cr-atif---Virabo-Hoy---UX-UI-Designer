...
import DataCulturePyramid from "@/components/course/ia-data-culture/DataCulturePyramid";
import AiAdoptionCurve from "@/components/course/ia-data-culture/AiAdoptionCurve";

export default function IaDataCulturePage() {
  const { language } = useLanguage();
  const course = iaDataCultureData;
  const lang = language as "fr" | "en";

  const illustrationAfterSection: Record<string, React.ComponentType> = {
    "what-is-data-culture": DataCulturePyramid,
    "ai-adoption": AiAdoptionCurve,
  };
  ...
  return (
    <>
      ...
      <CourseNavFooter basePath="/cours-ia"
        nextChapter={{
          slug: iaFuturMetiersData.slug,
          title: iaFuturMetiersData.title[lang],
        }}
      />
    </>
  );
