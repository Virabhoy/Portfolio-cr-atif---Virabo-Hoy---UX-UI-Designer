...
import McpArchitecture from "@/components/course/ia-mcp/McpArchitecture";
import McpVsApi from "@/components/course/ia-mcp/McpVsApi";

const illustrationAfterSection: Record<string, React.ComponentType> = {
  "architecture": McpArchitecture,
  "what-is-mcp": McpVsApi,
};

export default function IaMcpPage() {
  const { language } = useLanguage();
  const course = iaMcpData;
