...
import AiLandscape from "@/components/course/ia-introduction/AiLandscape";
import ContextWindowDiagram from "@/components/course/ia-introduction/ContextWindowDiagram";

const illustrationAfterSection: Record<string, React.ComponentType> = {
  "what-is-gen-ai": AiLandscape,
  "context-windows": ContextWindowDiagram,
};

export default function IaIntroductionPage() {
  const { language } = useLanguage();
  const course = iaIntroductionData;
    ...
    <>
      ...
      <CourseNavFooter basePath="/cours-ia"
        nextChapter={{
          ...
          title: iaPromptEngineeringData.title[lang],
        }}
      />
    </>
  );
