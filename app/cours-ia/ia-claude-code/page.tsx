...
import ClaudeCodeArchitecture from "@/components/course/ia-claude-code/ClaudeCodeArchitecture";
import ClaudeMdAnatomy from "@/components/course/ia-claude-code/ClaudeMdAnatomy";

const illustrationAfterSection: Record<string, React.ComponentType> = {
  "installation": ClaudeCodeArchitecture,
  "anatomy-claude-md": ClaudeMdAnatomy,
};

export default function IaClaudeCodePage() {
  const { language } = useLanguage();
  const course = iaClaudeCodeData;
