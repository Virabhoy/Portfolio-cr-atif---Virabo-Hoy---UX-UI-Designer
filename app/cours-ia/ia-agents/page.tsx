...
import AgentArchitecture from "@/components/course/ia-agents/AgentArchitecture";
import AgentVsAssistant from "@/components/course/ia-agents/AgentVsAssistant";

const illustrationAfterSection: Record<string, React.ComponentType> = {
  "architecture": AgentArchitecture,
  "agent-vs-assistant": AgentVsAssistant,
};

export default function IaAgentsPage() {
  const { language } = useLanguage();
  const course = iaAgentsData;
  ...
  return (
    <>
      ...
      <CourseNavFooter basePath="/cours-ia"
        nextChapter={{
          slug: "ia-workflows",
          title: iaWorkflowsData.title[lang],
        }}
      />
    </>
  );
