...
import JobsImpactMatrix from "@/components/course/ia-futur-metiers/JobsImpactMatrix";
import SkillsEvolution from "@/components/course/ia-futur-metiers/SkillsEvolution";

export default function IaFuturMetiersPage() {
  const { language } = useLanguage();
  const course = iaFuturMetiersData;
  const lang = language as "fr" | "en";

  const illustrationAfterSection: Record<string, React.ComponentType> = {
    "jobs-impact": JobsImpactMatrix,
    "skills-that-matter": SkillsEvolution,
  };
