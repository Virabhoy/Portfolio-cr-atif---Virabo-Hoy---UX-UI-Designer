...
import TcreiFramework from "@/components/course/ia-prompt-engineering/TcreiFramework";
import PromptAnatomy from "@/components/course/ia-prompt-engineering/PromptAnatomy";

const illustrationAfterSection: Record<string, React.ComponentType> = {
  "tcrei-framework": TcreiFramework,
  "task-definition": PromptAnatomy,
};

export default function IaPromptEngineeringPage() {
  const { language } = useLanguage();
  const course = iaPromptEngineeringData;
    ...
    <>
      ...
      <CourseNavFooter basePath="/cours-ia"
        nextChapter={{
          ...
          title: iaOutilsMarcheData.title[lang],
        }}
      />
    </>
  );
