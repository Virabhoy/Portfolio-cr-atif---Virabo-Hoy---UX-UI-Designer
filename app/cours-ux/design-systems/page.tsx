...
import DesignSystemLayers from "@/components/course/design-systems/DesignSystemLayers";
import DesignSystemBenefits from "@/components/course/design-systems/DesignSystemBenefits";

export default function DesignSystemsCoursePage() {
  const { language } = useLanguage();
  const course = designSystemsData;
  ...
  const illustrationAfter: Record<string, React.ReactNode> = {
    "not-a-library": <DesignSystemLayers />,
    "measuring-success": <DesignSystemBenefits />,
  };
