...
import ThumbZoneMap from "@/components/course/thumb-zone/ThumbZoneMap";
import ScreenSizeEvolution from "@/components/course/thumb-zone/ScreenSizeEvolution";
import ThumbZoneActions from "@/components/course/thumb-zone/ThumbZoneActions";
...
const illustrationSections: Record<string, React.ComponentType> = {
  hook: ThumbZoneMap,
  "phones-grew": ScreenSizeEvolution,
  "safe-zones-2026": ThumbZoneActions,
};

export default function ThumbZoneCoursePage() {
  const { language } = useLanguage();
  const course = thumbZoneData;
  ...
  return (
    <>
      ...
      <CourseNavFooter
        nextChapter={{
          slug: oneHandData.slug,
          title: oneHandData.title[lang],
        }}
      />
    </>
  );
