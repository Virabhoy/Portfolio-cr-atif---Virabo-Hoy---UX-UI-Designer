...
import NormanDoorDiagram from "@/components/course/affordance/NormanDoorDiagram";
import AffordanceLayers from "@/components/course/affordance/AffordanceLayers";
import AffordanceVsSignifier from "@/components/course/affordance/AffordanceVsSignifier";

const illustrationAfterSection: Record<string, React.ComponentType> = {
  hook: NormanDoorDiagram,
  "norman-vs-gibson": AffordanceLayers,
  signifiers: AffordanceVsSignifier,
};

export default function AffordanceCoursePage() {
  const { language } = useLanguage();
  const course = affordanceData;
